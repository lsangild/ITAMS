...
\begin{itemize}
	\item Must draw a maximum of \SI{500}{\milli\ampere} at peak, to be able to be driven from a USB 2.0 port. \fxnote{New requirement here. Maybe time without charging?}
