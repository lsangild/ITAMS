...
% Add extra spacing for tabulars
\setlength{\extrarowheight}{5pt}

% Redefine toprule and midrule to not have extra spacing above first row of table
\let\oldtoprule\toprule
\renewcommand*{\toprule}{\oldtoprule \\[-1.7\normalbaselineskip]}

\let\oldmidrule\midrule
\renewcommand*{\midrule}{\oldmidrule \\[-1.7\normalbaselineskip]}
